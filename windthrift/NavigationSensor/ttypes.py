...
NavigationData.thrift_spec = (
    ...
    (5, TType.STRUCT, 'position', [Common.ttypes.Vector, None], None, ),  # 5
    (6, TType.STRUCT, 'acceleration', [Common.ttypes.Vector, None], None, ),  # 6
    (7, TType.I32, 'numberOfSatellites', None, None, ),  # 7
    (8, TType.I32, 'qualityOfFix', None, None, ),  # 8
    (9, TType.STRUCT, 'orientation', [Common.ttypes.NauticalAngles, None], None, ),  # 9
    (10, TType.STRUCT, 'velocity', [Common.ttypes.Vector, None], None, ),  # 10
    (11, TType.DOUBLE, 'speed', None, None, ),  # 11
    (12, TType.STRUCT, 'angularRate', [Common.ttypes.Vector, None], None, ),  # 12
    (13, TType.STRUCT, 'magneticField', [Common.ttypes.Vector, None], None, ),  # 13
    (14, TType.STRUCT, 'gravityCompAccel', [Common.ttypes.Vector, None], None, ),  # 14
    (15, TType.STRUCT, 'positionErrorXYZ', [Common.ttypes.Vector, None], None, ),  # 15
    (16, TType.DOUBLE, 'positionError', None, None, ),  # 16
    (17, TType.STRUCT, 'velocityError', [Common.ttypes.Vector, None], None, ),  # 17
    (18, TType.DOUBLE, 'speedError', None, None, ),  # 18
    (19, TType.STRUCT, 'orientationError', [Common.ttypes.NauticalAngles, None], None, ),  # 19
    (20, TType.I64, 'timeError', None, None, ),  # 20
    (21, TType.I64, 'referenceFrameTimeStamp', None, None, ),  # 21
)
