...
class EnvironmentalSensorDefinition(object):
    ...
    def __init__(self, component=None, sensorType=None, location=None, componentPositionAndOrientation=None,):
...
EnvironmentalSensorDefinition.thrift_spec = (
    ...
    (7, TType.STRUCT, 'componentPositionAndOrientation', [Component.ttypes.GridPositionAndOrientation, None], None, ),  # 7
)
