...
class GammaListAndSpectrumConfiguration(object):
    ...
    Attributes:
     ...
     - energyResolution: Sensor resolution, specified at multiple energy levels. Must have sufficient entries to
    adequately characterize sensor resolution using a log/log interpolation to within 10%
    over the range 0-3000keV.
    """


    def __init__(self, componentId=None, settings=None, energyCalibration=None, componentPositionAndOrientation=None, energyResolution=None,):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    self.energyResolution = []
                    (_etype9, _size6) = iprot.readListBegin()
                    for _i10 in range(_size6):
                        _elem11 = DetectorCharacteristics.ttypes.EnergyResolution()
                        _elem11.read(iprot)
                        self.energyResolution.append(_elem11)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.energyCalibration is not None:
            ...
            for iter12 in self.energyCalibration:
                iter12.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.componentPositionAndOrientation is not None:
            ...
            oprot.writeFieldEnd()
        if self.energyResolution is not None:
            oprot.writeFieldBegin('energyResolution', TType.LIST, 5)
            oprot.writeListBegin(TType.STRUCT, len(self.energyResolution))
            for iter13 in self.energyResolution:
                iter13.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class GammaListAndSpectrumDefinition(object):
    ...
    def __init__(self, component=None, numberOfChannels=None, physicalDimensions=None, detectorMaterial=None, startingGammaConfiguration=None, angularEfficiencies=None,):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i18 in range(_size14):
                        _elem19 = Angular.ttypes.AngularEfficiencyDefinition()
                        _elem19.read(iprot)
                        self.angularEfficiencies.append(_elem19)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.angularEfficiencies is not None:
            ...
            for iter20 in self.angularEfficiencies:
                iter20.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class GammaSpectrumData(object):
    ...
    Attributes:
     ...
     - health
     - spectrum
     - liveTime: Send this only if things have changed
     - realTime
    """
...
class GammaListData(object):
    ...
    Attributes:
     ...
     - timeStamp: Milliseconds since UNIX epoch
     - health
     - listModeData: Send this only if things have changed
     - liveTime
     - realTime
    """
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i25 in range(_size21):
                        _elem26 = Spectrum.ttypes.ListMode()
                        _elem26.read(iprot)
                        self.listModeData.append(_elem26)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 6:
    ...
    def write(self, oprot):
        ...
        if self.listModeData is not None:
            ...
            for iter27 in self.listModeData:
                iter27.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.liveTime is not None:
...
class GammaGrossCountDefinition(object):
    ...
    def __init__(self, component=None, physicalDimensions=None, detectorMaterial=None, startingGammaGrossCountConfiguration=None, angularEfficiencies=None,):
        self.component = component
        self.physicalDimensions = physicalDimensions
        self.detectorMaterial = detectorMaterial
...
class GammaDoseDefinition(object):
    ...
    def __init__(self, component=None, physicalDimensions=None, detectorMaterial=None, startingGammaDoseConfiguration=None, angularEfficiencies=None,):
        self.component = component
        self.physicalDimensions = physicalDimensions
        self.detectorMaterial = detectorMaterial
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i39 in range(_size35):
                        _elem40 = Angular.ttypes.AngularEfficiencyDefinition()
                        _elem40.read(iprot)
                        self.angularEfficiencies.append(_elem40)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.angularEfficiencies is not None:
            oprot.writeFieldBegin('angularEfficiencies', TType.LIST, 8)
            oprot.writeListBegin(TType.STRUCT, len(self.angularEfficiencies))
            for iter41 in self.angularEfficiencies:
                iter41.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
GammaListAndSpectrumConfiguration.thrift_spec = (
    ...
    (4, TType.STRUCT, 'componentPositionAndOrientation', [Component.ttypes.GridPositionAndOrientation, None], None, ),  # 4
    (5, TType.LIST, 'energyResolution', (TType.STRUCT, [DetectorCharacteristics.ttypes.EnergyResolution, None], False), None, ),  # 5
)
