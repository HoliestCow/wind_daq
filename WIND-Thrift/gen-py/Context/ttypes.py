...
class MapOrigin(object):
    ...
    def __init__(self, originPosition=None, originLocation=None, heading=None,):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRUCT:
                    self.originPosition = Common.ttypes.Vector()
                    self.originPosition.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.STRUCT:
                    self.originLocation = Navigation.ttypes.Location()
                    self.originLocation.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            ...
            return
        oprot.writeStructBegin('MapOrigin')
        if self.originPosition is not None:
            oprot.writeFieldBegin('originPosition', TType.STRUCT, 1)
            self.originPosition.write(oprot)
            oprot.writeFieldEnd()
        if self.originLocation is not None:
            oprot.writeFieldBegin('originLocation', TType.STRUCT, 2)
            self.originLocation.write(oprot)
            oprot.writeFieldEnd()
        if self.heading is not None:
            oprot.writeFieldBegin('heading', TType.DOUBLE, 3)
...
class PointCloud(object):
    ...
    def __init__(self, pointData=None, origin=None,):
    ...
    def write(self, oprot):
        ...
        if self.origin is not None:
            oprot.writeFieldBegin('origin', TType.STRUCT, 9)
...
class VoxelMap(object):
    ...
    def __init__(self, sizeX=None, sizeY=None, sizeZ=None, edgeLength=None, voxelData=None, origin=None,):
        self.sizeX = sizeX
        self.sizeY = sizeY
        self.sizeZ = sizeZ
    ...
    def write(self, oprot):
        ...
        if self.voxelData is not None:
            ...
            oprot.writeFieldEnd()
        if self.origin is not None:
            oprot.writeFieldBegin('origin', TType.STRUCT, 13)
            self.origin.write(oprot)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class Mesh(object):
    ...
    def __init__(self, meshData=None, texture=None, origin=None,):
    ...
    def write(self, oprot):
        ...
        if self.texture is not None:
            ...
            oprot.writeFieldEnd()
        if self.origin is not None:
            oprot.writeFieldBegin('origin', TType.STRUCT, 10)
            self.origin.write(oprot)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class VelodyneData(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(MapOrigin)
MapOrigin.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'originPosition', [Common.ttypes.Vector, None], None, ),  # 1
    (2, TType.STRUCT, 'originLocation', [Navigation.ttypes.Location, None], None, ),  # 2
    (3, TType.DOUBLE, 'heading', None, None, ),  # 3
)
...
PointCloud.thrift_spec = (
    ...
    None,  # 7
    None,  # 8
    (9, TType.STRUCT, 'origin', [MapOrigin, None], None, ),  # 9
)
...
VoxelMap.thrift_spec = (
    ...
    None,  # 11
    None,  # 12
    (13, TType.STRUCT, 'origin', [MapOrigin, None], None, ),  # 13
)
...
Mesh.thrift_spec = (
    ...
    None,  # 8
    None,  # 9
    (10, TType.STRUCT, 'origin', [MapOrigin, None], None, ),  # 10
)
