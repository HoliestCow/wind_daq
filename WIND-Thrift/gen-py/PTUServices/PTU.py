...
class Iface(object):
    ...
    def deleteRecordings(self, recordingIds):
        """
    ...
    def addWaypoint(self, name, location):
        """
    ...
    def addMarker(self, name, type, location):
        """
    ...
    def addMapOverlay(self, name, location, width, height, type, image):
        """
    ...
    def editMapOverlay(self, overlay):
        """
    ...
    def deleteMapOverlay(self, mapOverlayId):
        """
    ...
    def getMapOverlays(self):
        """
        Returns a list of the current map overlays in the system.
        """
        pass

    def registerAlgorithm(self, uri, definition):
        """
...
class Client(Iface):
    ...
    def deleteRecordings(self, recordingIds):
        ...
        Parameters:
         - recordingIds
        """
        self.send_deleteRecordings(recordingIds)
        return self.recv_deleteRecordings()

    def send_deleteRecordings(self, recordingIds):
        self._oprot.writeMessageBegin('deleteRecordings', TMessageType.CALL, self._seqid)
        args = deleteRecordings_args()
        args.recordingIds = recordingIds
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_deleteRecordings(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = deleteRecordings_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        if result.error is not None:
            raise result.error
        raise TApplicationException(TApplicationException.MISSING_RESULT, "deleteRecordings failed: unknown result")
    ...
    def addWaypoint(self, name, location):
        ...
        Parameters:
         ...
         - location
        """
        self.send_addWaypoint(name, location)
        return self.recv_addWaypoint()

    def send_addWaypoint(self, name, location):
    ...
    def addMarker(self, name, type, location):
        ...
        Parameters:
         ...
         - location
        """
        self.send_addMarker(name, type, location)
        return self.recv_addMarker()

    def send_addMarker(self, name, type, location):
    ...
    def addMapOverlay(self, name, location, width, height, type, image):
        ...
        Parameters:
         ...
         - image
        """
        self.send_addMapOverlay(name, location, width, height, type, image)
        return self.recv_addMapOverlay()

    def send_addMapOverlay(self, name, location, width, height, type, image):
        self._oprot.writeMessageBegin('addMapOverlay', TMessageType.CALL, self._seqid)
        args = addMapOverlay_args()
        args.name = name
        args.location = location
        args.width = width
        args.height = height
    ...
    def recv_addMapOverlay(self):
        ...
        if result.error is not None:
            raise result.error
        raise TApplicationException(TApplicationException.MISSING_RESULT, "addMapOverlay failed: unknown result")
    ...
    def editMapOverlay(self, overlay):
        ...
        Parameters:
         - overlay
        """
        self.send_editMapOverlay(overlay)
        self.recv_editMapOverlay()

    def send_editMapOverlay(self, overlay):
        self._oprot.writeMessageBegin('editMapOverlay', TMessageType.CALL, self._seqid)
        args = editMapOverlay_args()
        args.overlay = overlay
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_editMapOverlay(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
    ...
    def deleteMapOverlay(self, mapOverlayId):
        ...
        Parameters:
         - mapOverlayId
        """
        self.send_deleteMapOverlay(mapOverlayId)
        self.recv_deleteMapOverlay()

    def send_deleteMapOverlay(self, mapOverlayId):
        self._oprot.writeMessageBegin('deleteMapOverlay', TMessageType.CALL, self._seqid)
        args = deleteMapOverlay_args()
        args.mapOverlayId = mapOverlayId
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_deleteMapOverlay(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = deleteMapOverlay_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.error is not None:
            raise result.error
    ...
    def getMapOverlays(self):
        ...
        Returns a list of the current map overlays in the system.
        """
        self.send_getMapOverlays()
        return self.recv_getMapOverlays()

    def send_getMapOverlays(self):
        self._oprot.writeMessageBegin('getMapOverlays', TMessageType.CALL, self._seqid)
        args = getMapOverlays_args()
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_getMapOverlays(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = getMapOverlays_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "getMapOverlays failed: unknown result")
    ...
    def registerAlgorithm(self, uri, definition):
        ...
        Parameters:
         ...
         - definition
        """
        self.send_registerAlgorithm(uri, definition)
        return self.recv_registerAlgorithm()

    def send_registerAlgorithm(self, uri, definition):
    ...
    def setCVRSAddress(self, uri):
        ...
        Parameters:
         - uri
        """
        self.send_setCVRSAddress(uri)
        self.recv_setCVRSAddress()

    def send_setCVRSAddress(self, uri):
        self._oprot.writeMessageBegin('setCVRSAddress', TMessageType.CALL, self._seqid)
        args = setCVRSAddress_args()
        args.uri = uri
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_setCVRSAddress(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
    ...
    def initiateCVRSSession(self):
        ...
        establish a session for any reason, a CVRSRegistrationError must be thrown.
        """
        self.send_initiateCVRSSession()
        return self.recv_initiateCVRSSession()

    def send_initiateCVRSSession(self):
        self._oprot.writeMessageBegin('initiateCVRSSession', TMessageType.CALL, self._seqid)
        args = initiateCVRSSession_args()
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_initiateCVRSSession(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = initiateCVRSSession_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        if result.error is not None:
            raise result.error
        raise TApplicationException(TApplicationException.MISSING_RESULT, "initiateCVRSSession failed: unknown result")
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap["deleteRecordings"] = Processor.process_deleteRecordings
        ...
        self._processMap["addMapOverlay"] = Processor.process_addMapOverlay
        self._processMap["editMapOverlay"] = Processor.process_editMapOverlay
        self._processMap["deleteMapOverlay"] = Processor.process_deleteMapOverlay
        self._processMap["getMapOverlays"] = Processor.process_getMapOverlays
        self._processMap["registerAlgorithm"] = Processor.process_registerAlgorithm
        self._processMap["setCVRSAddress"] = Processor.process_setCVRSAddress
        self._processMap["initiateCVRSSession"] = Processor.process_initiateCVRSSession
    ...
    def process_deleteRecordings(self, seqid, iprot, oprot):
        args = deleteRecordings_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = deleteRecordings_result()
        try:
            result.success = self._handler.deleteRecordings(args.recordingIds)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except Exceptions.ttypes.RecordingError as error:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("deleteRecordings", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
    ...
    def process_addWaypoint(self, seqid, iprot, oprot):
        ...
        result = addWaypoint_result()
        try:
            result.success = self._handler.addWaypoint(args.name, args.location)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except Exceptions.ttypes.UpdateError as error:
    ...
    def process_addMarker(self, seqid, iprot, oprot):
        ...
        result = addMarker_result()
        try:
            result.success = self._handler.addMarker(args.name, args.type, args.location)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except Exceptions.ttypes.UpdateError as error:
    ...
    def process_addMapOverlay(self, seqid, iprot, oprot):
        args = addMapOverlay_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = addMapOverlay_result()
        try:
            result.success = self._handler.addMapOverlay(args.name, args.location, args.width, args.height, args.type, args.image)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except Exceptions.ttypes.UpdateError as error:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("addMapOverlay", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_editMapOverlay(self, seqid, iprot, oprot):
        args = editMapOverlay_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = editMapOverlay_result()
        try:
            self._handler.editMapOverlay(args.overlay)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except Exceptions.ttypes.UpdateError as error:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("editMapOverlay", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_deleteMapOverlay(self, seqid, iprot, oprot):
        args = deleteMapOverlay_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = deleteMapOverlay_result()
        try:
            self._handler.deleteMapOverlay(args.mapOverlayId)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except Exceptions.ttypes.UpdateError as error:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("deleteMapOverlay", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_getMapOverlays(self, seqid, iprot, oprot):
        args = getMapOverlays_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = getMapOverlays_result()
        try:
            result.success = self._handler.getMapOverlays()
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("getMapOverlays", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
    ...
    def process_registerAlgorithm(self, seqid, iprot, oprot):
        ...
        result = registerAlgorithm_result()
        try:
            result.success = self._handler.registerAlgorithm(args.uri, args.definition)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
    ...
    def process_setCVRSAddress(self, seqid, iprot, oprot):
        args = setCVRSAddress_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = setCVRSAddress_result()
        try:
            self._handler.setCVRSAddress(args.uri)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("setCVRSAddress", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_initiateCVRSSession(self, seqid, iprot, oprot):
        args = initiateCVRSSession_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = initiateCVRSSession_result()
        try:
            result.success = self._handler.initiateCVRSSession()
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except Exceptions.ttypes.CVRSRegistrationError as error:
            msg_type = TMessageType.REPLY
            result.error = error
        except TApplicationException as ex:
            logging.exception('TApplication exception in handler')
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("initiateCVRSSession", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
class deleteRecordings_args(object):
    """
    Attributes:
     - recordingIds
    """
    ...
    def __init__(self, recordingIds=None,):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i11 in range(_size7):
                        _elem12 = UUID.ttypes.UUID()
                        _elem12.read(iprot)
                        self.recordingIds.append(_elem12)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('deleteRecordings_args')
        if self.recordingIds is not None:
            oprot.writeFieldBegin('recordingIds', TType.LIST, 1)
            oprot.writeListBegin(TType.STRUCT, len(self.recordingIds))
            for iter13 in self.recordingIds:
                iter13.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(deleteRecordings_args)
deleteRecordings_args.thrift_spec = (
    None,  # 0
    (1, TType.LIST, 'recordingIds', (TType.STRUCT, [UUID.ttypes.UUID, None], False), None, ),  # 1
)


class deleteRecordings_result(object):
    """
    Attributes:
     - success
     - error
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('deleteRecordings_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.BOOL, 0)
            oprot.writeBool(self.success)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(deleteRecordings_result)
deleteRecordings_result.thrift_spec = (
    (0, TType.BOOL, 'success', None, None, ),  # 0
    (1, TType.STRUCT, 'error', [Exceptions.ttypes.RecordingError, None], None, ),  # 1
)
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i39 in range(_size35):
                        _elem40 = PTUPayload.ttypes.DataPayload()
                        _elem40.read(iprot)
...
addWaypoint_args.thrift_spec = (
    ...
    (2, TType.STRUCT, 'location', [Navigation.ttypes.Location, None], None, ),  # 2
)
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i46 in range(_size42):
                        _elem47 = Navigation.ttypes.Waypoint()
                        _elem47.read(iprot)
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i53 in range(_size49):
                        _elem54 = Navigation.ttypes.Location()
                        _elem54.read(iprot)
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i60 in range(_size56):
                        _elem61 = Navigation.ttypes.BoundingBox()
                        _elem61.read(iprot)
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i67 in range(_size63):
                        _elem68 = WINDMessage.ttypes.Message()
                        _elem68.read(iprot)
...
addMarker_args.thrift_spec = (
    ...
    (3, TType.STRUCT, 'location', [Navigation.ttypes.Location, None], None, ),  # 3
)
...
class addMapOverlay_args(object):
    """
    Attributes:
     - name
     - location
    ...
    def __init__(self, name=None, location=None, width=None, height=None, type=None, image=None,):
        self.name = name
        self.location = location
        self.width = width
        self.height = height
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('addMapOverlay_args')
        if self.name is not None:
            oprot.writeFieldBegin('name', TType.STRING, 1)
            oprot.writeString(self.name.encode('utf-8') if sys.version_info[0] == 2 else self.name)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(addMapOverlay_args)
addMapOverlay_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'name', 'UTF8', None, ),  # 1
    (2, TType.STRUCT, 'location', [Navigation.ttypes.Location, None], None, ),  # 2
...
class addMapOverlay_result(object):
    """
    Attributes:
     - success
     - error
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = Navigation.ttypes.MapOverlay()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 1:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('addMapOverlay_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(addMapOverlay_result)
addMapOverlay_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [Navigation.ttypes.MapOverlay, None], None, ),  # 0
    (1, TType.STRUCT, 'error', [Exceptions.ttypes.UpdateError, None], None, ),  # 1
)


class editMapOverlay_args(object):
    """
    Attributes:
     - overlay
    """
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('editMapOverlay_args')
        if self.overlay is not None:
            oprot.writeFieldBegin('overlay', TType.STRUCT, 1)
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(editMapOverlay_args)
editMapOverlay_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'overlay', [Navigation.ttypes.MapOverlay, None], None, ),  # 1
)


class editMapOverlay_result(object):
    """
    Attributes:
     - error
    """
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('editMapOverlay_result')
        if self.error is not None:
            oprot.writeFieldBegin('error', TType.STRUCT, 1)
            self.error.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(editMapOverlay_result)
editMapOverlay_result.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'error', [Exceptions.ttypes.UpdateError, None], None, ),  # 1
)


class deleteMapOverlay_args(object):
    """
    Attributes:
     - mapOverlayId
    """
    ...
    def __init__(self, mapOverlayId=None,):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('deleteMapOverlay_args')
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(deleteMapOverlay_args)
deleteMapOverlay_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'mapOverlayId', [UUID.ttypes.UUID, None], None, ),  # 1
)


class deleteMapOverlay_result(object):
    """
    Attributes:
     - error
    """
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('deleteMapOverlay_result')
        if self.error is not None:
            oprot.writeFieldBegin('error', TType.STRUCT, 1)
            self.error.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(deleteMapOverlay_result)
deleteMapOverlay_result.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'error', [Exceptions.ttypes.UpdateError, None], None, ),  # 1
)


class getMapOverlays_args(object):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('getMapOverlays_args')
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(getMapOverlays_args)
getMapOverlays_args.thrift_spec = (
)


class getMapOverlays_result(object):
    """
    Attributes:
     - success
    """
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i81 in range(_size77):
                        _elem82 = Navigation.ttypes.MapOverlay()
                        _elem82.read(iprot)
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('getMapOverlays_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.LIST, 0)
            oprot.writeListBegin(TType.STRUCT, len(self.success))
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(getMapOverlays_result)
getMapOverlays_result.thrift_spec = (
    (0, TType.LIST, 'success', (TType.STRUCT, [Navigation.ttypes.MapOverlay, None], False), None, ),  # 0
)
...
class registerAlgorithm_args(object):
    ...
    def __init__(self, uri=None, definition=None,):
        self.uri = uri
...
class setCVRSAddress_args(object):
    """
    Attributes:
     - uri
    """
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('setCVRSAddress_args')
        if self.uri is not None:
            oprot.writeFieldBegin('uri', TType.STRING, 1)
            oprot.writeString(self.uri.encode('utf-8') if sys.version_info[0] == 2 else self.uri)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(setCVRSAddress_args)
setCVRSAddress_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'uri', 'UTF8', None, ),  # 1
)


class setCVRSAddress_result(object):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('setCVRSAddress_result')
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(setCVRSAddress_result)
setCVRSAddress_result.thrift_spec = (
)


class initiateCVRSSession_args(object):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('initiateCVRSSession_args')
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(initiateCVRSSession_args)
initiateCVRSSession_args.thrift_spec = (
)


class initiateCVRSSession_result(object):
    """
    Attributes:
     - success
     - error
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = UUID.ttypes.UUID()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 1:
                if ftype == TType.STRUCT:
                    self.error = Exceptions.ttypes.CVRSRegistrationError()
                    self.error.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('initiateCVRSSession_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(initiateCVRSSession_result)
initiateCVRSSession_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [UUID.ttypes.UUID, None], None, ),  # 0
    (1, TType.STRUCT, 'error', [Exceptions.ttypes.CVRSRegistrationError, None], None, ),  # 1
)
