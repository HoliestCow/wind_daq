...
class Marker(object):
    ...
    def __init__(self, markerId=None, timeStamp=None, name=None, type=None, latitude=None, longitude=None, altitude=None, unitId=None, gammaSpectrumData=None, gammaListData=None, gammaGrossCountData=None, gammaDoseData=None, neutronListData=None, neutronSpectrumData=None, neutronGrossCountData=None, environmentalData=None, algorithmData=None,):
    ...
    def write(self, oprot):
        ...
        if self.altitude is not None:
            oprot.writeFieldBegin('altitude', TType.DOUBLE, 7)
            oprot.writeDouble(self.altitude)
            oprot.writeFieldEnd()
        if self.unitId is not None:
            oprot.writeFieldBegin('unitId', TType.I64, 8)
...
Marker.thrift_spec = (
    ...
    (7, TType.DOUBLE, 'altitude', None, None, ),  # 7
    (8, TType.I64, 'unitId', None, None, ),  # 8
