...
class DetectionResult(object):
    ...
    def __init__(self, decisionMetric=None, timeOfDecision=None, resultantSpectrum=None, inAlarm=None,):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i11 in range(_size7):
                        ...
                        self.decisionMetric.append(_elem12)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.decisionMetric is not None:
            oprot.writeFieldBegin('decisionMetric', TType.LIST, 1)
            oprot.writeListBegin(TType.DOUBLE, len(self.decisionMetric))
            for iter13 in self.decisionMetric:
                oprot.writeDouble(iter13)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.timeOfDecision is not None:
            oprot.writeFieldBegin('timeOfDecision', TType.I64, 2)
...
DetectionResult.thrift_spec = (
    None,  # 0
    (1, TType.LIST, 'decisionMetric', (TType.DOUBLE, None, False), None, ),  # 1
    (2, TType.I64, 'timeOfDecision', None, None, ),  # 2
